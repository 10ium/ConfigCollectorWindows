...
pub fn save_content(base_dir: &Path, filename: &str, content_list: &BTreeSet<String>) -> Result<()> {
...
pub fn save_content_append(base_dir: &Path, filename: &str, new_content: &BTreeSet<String>) -> Result<()> {
...
pub fn write_files_standard(base_dir: &Path, data_map: &BTreeMap<String, BTreeSet<String>>) -> Result<()> {
...
pub fn write_files_standard_append(base_dir: &Path, data_map: &BTreeMap<String, BTreeSet<String>>) -> Result<()> {
    let mut mixed_content = BTreeSet::new();
    let mut cloudflare_content = BTreeSet::new();
    let mut slipnet_mixed_content = BTreeSet::new();
